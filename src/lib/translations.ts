...
export const t = {
  ar: {
    ...
    delete_confirm: "هل أنت متأكد من حذف هذا الطلب نهائياً؟",
    request_cancelled: "✅ تم إلغاء الطلب",
    request_deleted: "✅ تم حذف الطلب",
    cannot_cancel: "لا يمكن إلغاء طلب قيد التنفيذ",
  ...
  fr: {
    ...
    cancel_confirm: "Êtes-vous sûr d'annuler cette demande ?",
    delete_confirm: "Êtes-vous sûr de supprimer cette demande définitivement ?",
    request_cancelled: "✅ Demande annulée",
    request_deleted: "✅ Demande supprimée",
    cannot_cancel: "Impossible d'annuler une demande en cours",

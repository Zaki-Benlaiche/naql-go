      ...
      <div className="max-w-4xl">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-2xl border border-gray-100 p-5">
            ...
            <div className="text-sm text-gray-500 mt-0.5">{tr("available_requests")}</div>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 p-5">
            ...
            <div className="text-sm text-gray-500 mt-0.5">{tr("my_bids")}</div>
          </div>
          <div className="bg-white rounded-2xl border border-gray-100 p-5">
            ...
            <div className="text-sm text-gray-500 mt-0.5">{tr("accepted_bids")}</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100">
          <div className="p-5 border-b border-gray-100 flex items-center justify-between">
            <h2 className="font-bold text-gray-900">{tr("recent_available")}</h2>
          ...
          {loading ? (
            ...
            <div className="p-10 text-center text-gray-400 text-sm">{tr("no_available_now")}</div>
          ) : (
